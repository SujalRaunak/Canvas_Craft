    ...
    <div className="flex flex-1 items-center justify-end md:justify-between">
      <nav aria-label="Global" className="hidden md:block">
        <ul className="flex items-center gap-6 text-sm">
          <li>
            <a className="text-white transition hover:text-sky-300" href="#"> About </a>
          </li>

          <li>
            <a className="text-white transition hover:text-sky-300" href="#"> Services </a>
          </li>

          <li>
            <a className="text-white transition hover:text-sky-300" href="#"> Projects </a>
          </li>

          <li>
            <a className="text-white transition hover:text-sky-300" href="#"> Blog </a>
          </li>
        </ul>
      </nav>
